        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4 class="mb-3">Editar Motivo de Alarma</h4>
            </div>
            <div class="card-body">
              <form id="editForm" action="<?= base_url('motivo_alarma/update/'.$motivo_alarma['MOTIVO_ALARMA_ID']) ?>" method="post">
                <div class="form-group">
                  <label for="MOTIVO_ALARMA_NOMBRE">Nombre</label>
                  <input type="text" name="MOTIVO_ALARMA_NOMBRE" class="form-control" value="<?= $motivo_alarma['MOTIVO_ALARMA_NOMBRE'] ?>" required>
                </div>
                <div class="form-group">
                  <label for="MOTIVO_ALARMA_DESCRIPCION">Descripción</label>
                  <input type="text" name="MOTIVO_ALARMA_DESCRIPCION" class="form-control" value="<?= $motivo_alarma['MOTIVO_ALARMA_DESCRIPCION'] ?>" required>
                </div>
