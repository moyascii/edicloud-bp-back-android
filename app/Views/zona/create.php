        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4 class="mb-3">Crear Nueva Zona</h4>
            </div>
            <div class="card-body">
              <form id="createForm" action="<?= base_url('zona/store') ?>" method="post">
                <div class="form-group">
                  <label for="ZONA_NOMBRE">Nombre</label>
                  <input type="text" name="ZONA_NOMBRE" class="form-control" required>
                </div>
