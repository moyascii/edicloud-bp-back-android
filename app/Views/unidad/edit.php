        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4 class="mb-3">Editar Unidad</h4>
            </div>
            <div class="card-body">
              <form id="editForm" action="<?= base_url('unidad/update/'.$unidad['UNIDAD_ID']) ?>" method="post">
                <div class="form-group">
                  <label for="UNIDAD_DIRECCION">Dirección</label>
                  <input type="text" name="UNIDAD_DIRECCION" class="form-control" value="<?= $unidad['UNIDAD_DIRECCION'] ?>" required>
                </div>
                <div class="form-group">
                  <label for="UNIDAD_NUMERO">Número</label>
                  <input type="number" name="UNIDAD_NUMERO" class="form-control" value="<?= $unidad['UNIDAD_NUMERO'] ?>" required>
                </div>
