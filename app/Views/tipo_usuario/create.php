        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4 class="mb-3">Crear Nuevo Tipo de Usuario</h4>
            </div>
            <div class="card-body">
              <form id="createForm" action="<?= base_url('tipo_usuario/store') ?>" method="post">
                <div class="form-group">
                  <label for="TIPO_USUARIO_NOMBRE">Nombre</label>
                  <input type="text" name="TIPO_USUARIO_NOMBRE" class="form-control" required>
                </div>
